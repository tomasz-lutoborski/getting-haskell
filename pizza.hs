...
personData :: Map.Map Int String
personData = Map.fromList [(1, "John"), (2, "Mary"), (3, "Bob")]

maybeMain :: Maybe String
maybeMain = do
  name1 <- Map.lookup 1 personData
  name2 <- Map.lookup 2 personData
  return (name1 ++ " " ++ name2)
